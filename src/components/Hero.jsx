...
const Hero = () => (
  ...
  >
    <div
      className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 sm:min-w-[695px] w-full`}
    >
      ...
      <h1 className=" font-poppins font-semibold ss:text-[68px] text-[52px] ss:leading-[90px] leading-[75px] w-full">
        Payment Method.
      </h1>
